...
namespace LMS.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        /// </summary>
        /// <returns>
        /// A new unique uID that is not currently in use by aLny student, professor, or administrator
        /// </returns>
        ...
        {
            int creating_id = 1000000;
            string creating_u_id = "u" + creating_id.ToString();

            while (true){
                var get_uID = from u_table in _lMSContext.Users
                              where u_table.UId == creating_u_id
                              select u_table.UId;
                if(get_uID.Count() != 0)
                {
                    creating_id++;
                    creating_u_id = "u" + creating_id.ToString();
                }
                else
                {
                    break;
            ...
            if (role == "Student")
            {
                ...
                newStudent.UId = creating_u_id;
                newStudent.MajorIn = departmentAbbrev;
            ...
            if(role == "Professor")
            {
                ...
                newProfessor.UId = creating_u_id;
                newProfessor.WorkIn = departmentAbbrev;
            ...
            if(role == "Administrator")
            {
                ...
                newAd.UId = creating_u_id;
                _lMSContext.Administrators.Add(newAd);
                _lMSContext.SaveChanges();
            }

            return creating_u_id;
        }
